...
$(document).foundation(),function(n){n(document).ready(function(){n.fn.extend({deBounce:function(n,t,e){var o;return function(){var u=this,i=arguments,c=function(){o=null,e||n.apply(u,i)},r=e&&!o;clearTimeout(o),o=setTimeout(c,t),r&&n.apply(u,i)}}});var t=jQuery().deBounce(function(){n(".content").velocity("transition.slideDownIn")},500);t()})}(jQuery);